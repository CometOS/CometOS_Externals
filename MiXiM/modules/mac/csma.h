...
class  csma : public BaseMacLayer
{
  ...
  protected:
    ...
    /*@{*/
    omnetpp::cMessage * backoffTimer, * ccaTimer, * txTimer, * sifsTimer, * rxAckTimer;
    /*@}*/
...
protected:
	...
	void updateStatusBackoff(t_mac_event event, omnetpp::cMessage *msg);
	...
	virtual omnetpp::cPacket *decapsMsg(MacPkt * macPkt);
	MacPkt * ackMessage;
