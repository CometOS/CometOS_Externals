...
public:
    ...
    static constexpr double Gtx = 1, Grx = 1, ntx = 1, nrx = 1;
    double PL0; // 0.000008913; // -50.5 dB   0.000019953
    static constexpr double fc = 4492.8; // mandatory band 3, center frequency, MHz
    ...
    static constexpr double s_mu = 1.6, s_sigma = 0.5;
    static constexpr double kappa = 1;

    bool isEnabled, shadowing;

    omnetpp::cOutVector distances;
    omnetpp::cOutVector srcPosX, srcPosY, dstPosX, dstPosY;
