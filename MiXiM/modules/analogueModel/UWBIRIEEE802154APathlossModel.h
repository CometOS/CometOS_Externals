...
protected:
    ...
    static constexpr double PL0 = 0.000040738; // -43.9 dB
    static constexpr double pathloss_exponent = 1.79;
    static constexpr double meanL = 3;
    static constexpr double Lambda = 0.047E9;
    static constexpr double lambda1 = 1.54E9;
    static constexpr double lambda2 = 0.15E9;
    static constexpr double Beta = 0.095;
    static constexpr double Gamma = 22.61E-9;
    static constexpr double k_gamma = 0;
    static constexpr double gamma_0 = 12.53 * 0.001 * 0.001 * 0.01;
    static constexpr double sigma_cluster = 1.883649089; // 2.75 dB

    static constexpr double fc = 4.492E9; // mandatory band 3, center frequency, Hz
    static constexpr double BW = 500E6;  //  mandatory band 3, bandwidth, Hz
    static constexpr double fcMHz = 4492; // mandatory band 3, center frequency, MHz

    static constexpr double d0 = 1;

    // antenna parameters
    static constexpr double ntx = 1;
    static constexpr double nrx = 1;
    ...
    long nbCalls;
    omnetpp::cOutVector averagePowers;
    omnetpp::cOutVector pathlosses;  // outputs computed pathlosses. Allows to compute Eb = Epulse*pathloss for Eb/N0 computations. (N0 is the noise sampled by the receiver)
