...
protected:
	 ...
	 */
	void sendSelfMessage(omnetpp::cMessage* msg, simtime_t time);
...
public:
	 ...
	 *
	 */
	virtual void sendControlMsg(omnetpp::cMessage* msg);
	 ...
	 */
	virtual void rescheduleMessage(omnetpp::cMessage* msg, simtime_t t);
