...
class Blackboard : public omnetpp::cSimpleModule
{
protected:
...
protected:
 ...
 public:
    /** import names from super class to allow overloading without warning here */
    using omnetpp::cComponent::subscribe;
    using omnetpp::cComponent::unsubscribe;
